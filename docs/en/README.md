...
heroImage: /logo.svg
heroText: sv-print
tagline: Print designer developed by svelte (based on hiprint)
actions:
  - text: guide 💡
    link: guide/
    type: primary
  ...
  - text: demo 🎾
    link: https://ccsimple.gitee.io/vue-plugin-hiprint/
    type: primary
...
copyright: false
footer: Apache Licensed | Copyright © 2022-present sv-print
---
